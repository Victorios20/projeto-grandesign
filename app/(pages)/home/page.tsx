    ...
    <PageLayout links={homeLinks}>
      <div className="w-full h-full flex flex-row flex-wrap items-start gap-4 p-6 text-foreground">
        {homeItems.map((item) => (
          ...
          >
            <Card className="aspect-square w-36 cursor-pointer flex flex-col items-center justify-center gap-0 bg-transparent hover:bg-accent hover:text-accent-foreground transition-colors shadow-none">
